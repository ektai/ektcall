...
- UiKit - Interactive UI elements for Ekt.Ai Apps ([#16048](https://github.com/RocketChat/Rocket.Chat/pull/16048))
...
- CAS users can take control of Ekt.Ai accounts ([#15346](https://github.com/RocketChat/Rocket.Chat/pull/15346))
...
- Assume that Ekt.Ai runs behind one proxy by default (HTTP_FORWARDED_COUNT=1) ([#15214](https://github.com/RocketChat/Rocket.Chat/pull/15214))
...
- EktAi  client sending out video call requests unnecessarily ([#14496](https://github.com/RocketChat/Rocket.Chat/pull/14496))
...
- Require OPLOG/REPLICASET to run Ekt.Ai ([#14227](https://github.com/RocketChat/Rocket.Chat/pull/14227))

### 🎉 New features

- Marketplace integration with Ekt.Ai Cloud ([#13809](https://github.com/RocketChat/Rocket.Chat/pull/13809))
...
- Allow custom ekt.aiusername for crowd users and enable login via email/crowd_username ([#12981](https://github.com/RocketChat/Rocket.Chat/pull/12981) by [@steerben](https://github.com/steerben))
...
- In home screen Rocket.Chat+ is dispalyed as Ekt.Ai ([#13784](https://github.com/RocketChat/Rocket.Chat/pull/13784) by [@ashwaniYDV](https://github.com/ashwaniYDV))
...
- Improve: Marketplace auth inside Ekt.Ai instead of inside the iframe.   ([#14258](https://github.com/RocketChat/Rocket.Chat/pull/14258))
...
-  Remove dependency of EktAi  namespace and push-notifications ([#13137](https://github.com/RocketChat/Rocket.Chat/pull/13137))
- Remove dependency of EktAi  namespace and custom-sounds ([#13136](https://github.com/RocketChat/Rocket.Chat/pull/13136))
- Remove dependency of EktAi  namespace and logger ([#13135](https://github.com/RocketChat/Rocket.Chat/pull/13135))
- Remove dependency between EktAi  namespace and migrations ([#13133](https://github.com/RocketChat/Rocket.Chat/pull/13133))
- Convert rocketchat:ui to main module structure ([#13132](https://github.com/RocketChat/Rocket.Chat/pull/13132))
- Remove dependency of EktAi  namespace inside rocketchat:ui ([#13131](https://github.com/RocketChat/Rocket.Chat/pull/13131))
...
- ekt.aimailer ([#13036](https://github.com/RocketChat/Rocket.Chat/pull/13036))
- Move ekt.aipromises ([#13039](https://github.com/RocketChat/Rocket.Chat/pull/13039))
- Globals/move ekt.ainotifications ([#13035](https://github.com/RocketChat/Rocket.Chat/pull/13035))
- Test only MongoDB with oplog versions 3.2 and 4.0 for PRs ([#13119](https://github.com/RocketChat/Rocket.Chat/pull/13119))
- Move/create ekt.aicallbacks ([#13034](https://github.com/RocketChat/Rocket.Chat/pull/13034))
- Move/create ekt.aimetrics ([#13032](https://github.com/RocketChat/Rocket.Chat/pull/13032))
- Move ekt.aimodels ([#13027](https://github.com/RocketChat/Rocket.Chat/pull/13027))
- Move ekt.aisettings to specific package ([#13026](https://github.com/RocketChat/Rocket.Chat/pull/13026))
...
- Add nyan rocket on Ekt.Ai preview Docker image ([#11684](https://github.com/RocketChat/Rocket.Chat/pull/11684))
...
- Missing attachment description when Ekt.Ai Apps were enabled ([#10705](https://github.com/RocketChat/Rocket.Chat/pull/10705) by [@Hudell](https://github.com/Hudell))
...
- Regression: Ekt.Ai App author link opens in same window ([#10575](https://github.com/RocketChat/Rocket.Chat/pull/10575) by [@kaiiiiiiiii](https://github.com/kaiiiiiiiii))
...
- Interface to install and manage EktAi  Apps (alpha) ([#10246](https://github.com/RocketChat/Rocket.Chat/pull/10246))
...
- Add a few listener supports for the Ekt.Ai Apps ([#10154](https://github.com/RocketChat/Rocket.Chat/pull/10154))
...
- Fix: inputs for ekt.aiapps ([#10274](https://github.com/RocketChat/Rocket.Chat/pull/10274))
...
- [OTHER] Ekt.Ai Apps ([#9666](https://github.com/RocketChat/Rocket.Chat/pull/9666))
...
- Can't use OAuth login against a Ekt.Ai OAuth server ([#9044](https://github.com/RocketChat/Rocket.Chat/pull/9044))
...
- Update Ekt.Ai for sandstorm ([#9062](https://github.com/RocketChat/Rocket.Chat/pull/9062) by [@peterlee0127](https://github.com/peterlee0127))
...
- Ekt.Ai UI Redesign ([#7643](https://github.com/RocketChat/Rocket.Chat/pull/7643))
...
- ekt.aiui3 ([#7006](https://github.com/RocketChat/Rocket.Chat/pull/7006))
...
- ekt.aiui message ([#6914](https://github.com/RocketChat/Rocket.Chat/pull/6914))
...
- ekt.ailib2 ([#6593](https://github.com/RocketChat/Rocket.Chat/pull/6593))
...
- Drupal oAuth Integration for ekt.ai([#6632](https://github.com/RocketChat/Rocket.Chat/pull/6632) by [@Lawri-van-Buel](https://github.com/Lawri-van-Buel))
...
- converted ekt.ailogger coffee to js ([#6495](https://github.com/RocketChat/Rocket.Chat/pull/6495))
