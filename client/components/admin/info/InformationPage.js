			...
			{alertOplogForMultipleInstances
				&& <Margins blockEnd='x16'>
					<Callout type='danger' title={t('Error_RocketChat_requires_oplog_tailing_when_running_in_multiple_instances')}>
						...
						<p>
							<Link external href='https://ekt.ai/docs/installation/manual-installation/multiple-instances-to-improve-performance/#running-multiple-instances-per-host-to-improve-performance'>
