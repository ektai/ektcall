...
describe('The AppMessagesConverter instance', function() {
	...
	describe('when converting a message from Ekt.Ai to the Engine schema', function() {
		...
		it('should return basic sender info when it\'s not a Ekt.Ai user (e.g. Livechat Guest)', function() {
