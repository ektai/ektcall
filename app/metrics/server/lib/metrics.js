...
metrics.version = new client.Gauge({ name: 'rocketchat_version', labelNames: ['version'], help: 'Ekt.Ai version' });
...
app.use('/', (req, res) => {
	const html = `<html>
		<head>
			<title>Ekt.Ai Prometheus Exporter</title>
		</head>
		<body>
			<h1>Ekt.Ai Prometheus Exporter</h1>
