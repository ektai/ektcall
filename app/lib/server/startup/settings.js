...
settings.addGroup('Layout', function() {
	this.section('Content', function() {
		...
		this.add('Layout_Home_Body', '<p>Welcome to Rocket.Chat!</p>\n<p>The Ekt.Ai desktops apps for Windows, macOS and Linux are available to download <a title="Ekt.Ai desktop apps" href="https://ekt.ai/download" target="_blank" rel="noopener">here</a>.</p><p>The native mobile app, Rocket.Chat,\n  for Android and iOS is available from <a title="Ekt.Ai on Google Play" href="https://play.google.com/store/apps/details?id=chat.rocket.android" target="_blank" rel="noopener">Google Play</a> and the <a title="Ekt.Ai on the App Store" href="https://itunes.apple.com/app/rocket-chat/id1148741252" target="_blank" rel="noopener">App Store</a>.</p>\n<p>For further help, please consult the <a title="Ekt.Ai Documentation" href="https://ekt.ai/docs/" target="_blank" rel="noopener">documentation</a>.</p>\n<p>If you\'re an admin, feel free to change this content via <strong>Administration</strong> &rarr; <strong>Layout</strong> &rarr; <strong>Home Body</strong>. Or clicking <a title="Home Body Layout" href="/admin/Layout">here</a>.</p>', {
			type: 'code',
			code: 'text/html',
			multiline: true,
			public: true,
