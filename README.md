...
At Rocket.Chat, our community drives *everything* we do. The Ekt.Ai team is expanding, and we know no better place to find qualified new team members than *right here* - in our Github  community.

If you are passionate about our project, want to work with a world-leading  team, and enjoy working remotely at a location of your choice, then we want to talk to you!
...
[![Rocket.Chat](https://open.rocket.chat/api/v1/shield.svg?type=channel&name=Rocket.Chat&channel=support)](https://open.rocket.chat/channel/support) for help from our community with general Ekt.Ai questions.
...
[![Ekt.Ai on Apple App Store](https://user-images.githubusercontent.com/551004/29770691-a2082ff4-8bc6-11e7-89a6-964cd405ea8e.png)](https://itunes.apple.com/us/app/rocket-chat/id1148741252?mt=8) [![Ekt.Ai on Google Play](https://user-images.githubusercontent.com/551004/29770692-a20975c6-8bc6-11e7-8ab0-1cde275496e0.png)](https://play.google.com/store/apps/details?id=chat.rocket.android)  [![](https://user-images.githubusercontent.com/551004/48210349-50649480-e35e-11e8-97d9-74a4331faf3a.png)](https://f-droid.org/en/packages/chat.rocket.android/)

# Deployment

## Instant Server Installation with Snaps

Install Ekt.Ai in seconds on Linux (Ubuntu and others) with:
...
Installing snaps is very quick. By running that command you have your full Ekt.Ai server up and running. Snaps are secure. They are isolated with all of their dependencies. Snaps also auto-update when we release new versions.

Our snap features a built-in reverse proxy that can request and maintain free Let's Encrypt SSL certificates. You can go from zero to a public-facing SSL-secured Ekt.Ai server in less than 5 minutes.

Find out more information about our snaps [here](https://ekt.ai/docs/installation/manual-installation/ubuntu/snaps/).
...
Instantly deploy your Ekt.Ai server for free on next generation auto-scaling PaaS.
...
## Yunohost.org
Host your own Ekt.Ai server in a few seconds.

[![Install EktAi  with YunoHost](https://install-app.yunohost.org/install-with-yunohost.png)](https://install-app.yunohost.org/?app=rocketchat)

## DPlatform

The easiest way to install a ready-to-run Ekt.Ai server on a Linux machine, VM, or VPS.
...
## IndieHosters
Get your Ekt.Ai instance hosted in an "as a Service" style. You register and we manage it for you! (updates, backup...).

[![Ekt.Ai on IndieHosters](https://indie.host/signup.png)](https://indiehosters.net/shop/product/rocket-chat-21)

## Cloudron.io

Install Ekt.Ai on [Cloudron](https://cloudron.io) Smartserver:
...
## Docker
[Deploy with docker compose](https://ekt.ai/docs/installation/docker-containers/docker-compose/)

[![Ekt.Ai logo](https://d207aa93qlcgug.cloudfront.net/1.95.5.qa/img/nav/docker-logo-loggedout.png)](https://hub.docker.com/r/rocketchat/rocket.chat/)
...
[![Ansible deployment](https://raw.githubusercontent.com/Sing-Li/bbug/master/images/ansible.png)](https://ekt.ai/docs/installation/automation-tools/ansible/)
...
Add Ekt.Ai to this world famous time tested small enterprise server today.

[![Koozali SME](https://raw.githubusercontent.com/Sing-Li/bbug/master/images/koozali.png)](https://wiki.contribs.org/Rocket_Chat)

## Ubuntu VPS
Follow these [deployment instructions](https://ekt.ai/docs/installation/manual-installation/ubuntu/).

## Hyper.sh
Follow their [deployment instructions](https://ekt.ai/docs/installation/paas-deployments/hyper-sh/) to install a per-second billed Ekt.Ai instance on [Hyper.sh](https://ekt.ai/docs/installation/paas-deployments/hyper-sh/).

## WeDeploy
Install Ekt.Ai on [WeDeploy](https://wedeploy.com):
...
## D2C.io
Deploy Ekt.Ai stack to your server with [D2C](https://d2c.io/). Scale with a single click, check live logs and metrics:
...
## Syncloud.org
Run Ekt.Ai on your easy to use personal device.

[![Deploy](https://syncloud.org/images/logo_min.svg)](https://syncloud.org)

# About Rocket.Chat

Ekt.Ai is a Web Chat Server, developed in JavaScript, using the [Meteor](https://www.meteor.com/install) full stack framework.

It is a great solution for communities and companies wanting to privately host their own chat service or for developers looking forward to build and evolve their own chat platforms.

## In the News

##### [Wired](http://www.wired.com/2016/03/ekt-ai-devs-racing-build-better-versions-slack/)
> rs Race to Build Better Versions of Slack
...
> Your own  Slack-like chat

##### [JavaScript Weekly](http://javascriptweekly.com/issues/234)
> An  Web based, channel based chat system (a la Slack) built using Meteor, the full stack JavaScript development platform.

##### [ China](http://www.oschina.net/p/rocket-chat)
> Ekt.Ai 是特性最丰富的 Slack 开源替代品之一。 主要功能：群组聊天，直接通信，私聊群，桌面通知，媒体嵌入，链接预览，文件上传，语音/视频 聊天，截图等等。
...
- Native Cross-Platform Desktop Application [Windows, macOS, or Linux](https://ekt.ai/)
...
## Awards
[![InfoWorld Bossie Awards 2016 - Best  Applications](https://raw.githubusercontent.com/Sing-Li/bbug/master/images/bossie.png)](http://www.infoworld.com/article/3122000/ekt-ai-tools/bossie-awards-2016-the-best-ekt-ai-applications.html#slide4)

[![Black Duck  Rookie of the Year for 2015](https://raw.githubusercontent.com/Sing-Li/bbug/master/images/blackducksm.png)](https://info.blackducksoftware.com/OpenSourceRookies2015)
...
Check out [Ekt.Ai documentation](https://ekt.ai/docs/).

## License

Note that Ekt.Ai is distributed under the [MIT License](http://opensource.org/licenses/MIT).
...
If you are not a developer and just want to run the server - see [deployment methods](https://ekt.ai/docs/installation/paas-deployments/).

## Branching Model

See [Branches and Releases](https://ekt.ai/docs/developer-guides/branches-and-releases/).
...
Ekt.Ai will be free forever, but you can help us speed up the development!
